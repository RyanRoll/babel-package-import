    ...
    value: function loadPackage(dirPath, exportExpression) {
      ...
      list.forEach(function (fileName) {
        ...
        if (stat.isFile()) {
          ...
          _this.assignToPackageVar(_this.t.memberExpression(exportExpression, _this.t.stringLiteral(subNamespace), true), cachedFile);
          ...
          _this.loadPackage(nextDirPath, nextExportExpression);
        }
      });
    }
  }, {
